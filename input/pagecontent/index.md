...
<ul>
    <li>Home: The home page provides the introduction and background information to set context for the use of the HL7 FHIR® SPLASCH Implementation Guide.</li>
    <li>FHIR Artifacts: These sections provide detailed descriptions and formal definitions for all the FHIR objects defined in this guide.
        <ul>
            ...
            <li>Search Parameters: This section lists the HL7 FHIR® SPLASCH Implementation Guide defined Search Parameters.</li>
